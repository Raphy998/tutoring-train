 ...
 */
public class AllRequestsController implements Initializable, TutoringTrainWindow, MessageListener, RequestNewestRequestsListener, RequestRequestSearchListener, RemoveItemListener {
    @FXML
